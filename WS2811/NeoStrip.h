...
class NeoStrip
{
    public:
         ...
         * @param n The number of pixels to set.
         * @param colors An array of length n containing the 24-bit colors for each pixel
         * @param bright An array of length n containing the brightness factor (0.0 -> 1.0) for each pixel
         */
        void setPixels(int p, int n, const int *colors, const int *bright);
	...
	/**
	 * Calls setPixel N times to change all pixels to color.
	 */
