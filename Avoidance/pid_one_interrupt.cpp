// A variation on (./pid_three_interrupt_2.cpp) where all sensors call the same
// interrupt. This is done so that if the interrupts stack, there is no problem as this
// just raises an interrupt flag, where the motor speed calculations will be handled later,
// rather than the program receiving instructions to turn left, right, and backwards all
// at once.
